...
from .services import (add_feedback_data_service, get_all_feedback_data_service,
                       update_feedback_data_by_id_service, delete_feedback_data_by_id_service, get_pdf_feedback_data_service)
...
@feedbacks_data.route("/feedback_data/<int:id_pdf>", methods=["GET"])
def get_pdf_sensors_data(id_pdf):
    return get_pdf_feedback_data_service(id_pdf)
